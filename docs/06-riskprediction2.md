...
\begin{align}
BS_{\textrm{naive}}(t; S) &= \frac{1}{n} \sum_{i=1}^{n} \Big( Y_{i}(t) - P\{Y_{i}(t)=1 | \mathbf{x}_{i} \}  \Big)^2 \nonumber \\
&= \frac{1}{n} \sum_{i=1}^{n} \Big( I(T_{i} > t) - S(t|\mathbf{x}_{i}) \Big)^2
\end{align}
